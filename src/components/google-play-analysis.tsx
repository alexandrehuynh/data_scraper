...
const OnePassGooglePlayAnalysis = () => {
      ...
      <div className="bg-white p-4 rounded shadow">
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>Address critical Android compatibility issues, especially for Android 14</li>
            <li>Fix app crashes on startup which prevent basic app usage</li>
            <li>Repair login functionality and user authentication system</li>
            <li>Fix the gym locator feature which is core to the app's functionality</li>
            <li>Implement proper testing before releasing updates</li>
          </ol>
        </div>
      </div>
    </div>
...
export default OnePassGooglePlayAnalysis;